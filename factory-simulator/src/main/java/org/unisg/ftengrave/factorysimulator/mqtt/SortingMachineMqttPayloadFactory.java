...
public class SortingMachineMqttPayloadFactory {
  ...
  public String createPayload() {
    ...
    addCommonMachineFields(payload, sink_i_item == null ? "ready" : "running");
    ...
    payload.put("m1_speed", 0);
    payload.put("o5_valve", 0);
    payload.put("o6_valve", 0);
    payload.put("o7_valve", 0);
    payload.put("o8_compressor", 0);
    payload.put("current_task", sink_i_item == null ? "idle" : "detect_color");
    payload.put("current_task_duration", sink_i_item == null ? 0.0d : 2.0d);
    payload.put("current_sub_task", "");
  ...
  public String createColorDetectionPayload(Item detectedItem) {
    ...
    addCommonMachineFields(payload, "running");
  ...
  private void addCommonMachineFields(Map<String, Object> payload, String currentState) {
    payload.put("id", UUID.randomUUID().toString());
    payload.put("station", "SM_1");
